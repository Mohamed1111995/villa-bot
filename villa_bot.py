...
async def receive_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data["photo_count"] >= 44:
        await update.message.reply_text("الحد الأقصى 44 صورة. اكتب /done للمتابعة.")
        return PHOTO
    ...
    await update.message.reply_text(
        f"صورة {data['photo_count']} تم حفظها - ارسل أخرى أو اكتب /done"
    )
    return PHOTO
